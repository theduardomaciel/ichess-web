	...
	return (
		...
		>
			...
			<div className="flex flex-col sm:flex-row sm:gap-[calc(var(--wrapper)*2)] items-center justify-end gap-[var(--wrapper)] w-full">
				<ul
					className={cn(
						"flex flex-row items-center justify-between md:justify-center md:gap-12 max-md:w-full transition-[opacity,transform] md:absolute md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2",
						{
